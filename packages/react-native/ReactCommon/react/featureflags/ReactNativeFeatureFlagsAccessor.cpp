 ...
 *
 * @generated SignedSource<<3f09632542a7843d543070fc8ce2dd45>>
 */
...
bool ReactNativeFeatureFlagsAccessor::enableFixForParentTagDuringReparenting() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(25, "enableFixForParentTagDuringReparenting");
...
bool ReactNativeFeatureFlagsAccessor::enableIOSExperimentalAutoFocusImplementation() {
  auto flagValue = enableIOSExperimentalAutoFocusImplementation_.load();
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(27, "enableIOSExperimentalAutoFocusImplementation");

    flagValue = currentProvider_->enableIOSExperimentalAutoFocusImplementation();
    enableIOSExperimentalAutoFocusImplementation_ = flagValue;
  }
...
bool ReactNativeFeatureFlagsAccessor::enableSchedulerDelegateInvalidation() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(47, "enableSchedulerDelegateInvalidation");
...
bool ReactNativeFeatureFlagsAccessor::enableSwiftUIBasedFilters() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(48, "enableSwiftUIBasedFilters");
...
bool ReactNativeFeatureFlagsAccessor::enableViewCulling() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(49, "enableViewCulling");
...
bool ReactNativeFeatureFlagsAccessor::enableViewRecycling() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(50, "enableViewRecycling");
...
bool ReactNativeFeatureFlagsAccessor::enableViewRecyclingForImage() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(51, "enableViewRecyclingForImage");
...
bool ReactNativeFeatureFlagsAccessor::enableViewRecyclingForScrollView() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(52, "enableViewRecyclingForScrollView");
...
bool ReactNativeFeatureFlagsAccessor::enableViewRecyclingForText() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(53, "enableViewRecyclingForText");
...
bool ReactNativeFeatureFlagsAccessor::enableViewRecyclingForView() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(54, "enableViewRecyclingForView");
...
bool ReactNativeFeatureFlagsAccessor::enableVirtualViewContainerStateExperimental() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(55, "enableVirtualViewContainerStateExperimental");
...
bool ReactNativeFeatureFlagsAccessor::enableVirtualViewDebugFeatures() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(56, "enableVirtualViewDebugFeatures");
...
bool ReactNativeFeatureFlagsAccessor::fixDifferentiatorParentTagForUnflattenCase() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(57, "fixDifferentiatorParentTagForUnflattenCase");
...
bool ReactNativeFeatureFlagsAccessor::fixFindShadowNodeByTagRaceCondition() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(58, "fixFindShadowNodeByTagRaceCondition");
...
bool ReactNativeFeatureFlagsAccessor::fixYogaFlexBasisFitContentInMainAxis() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(60, "fixYogaFlexBasisFitContentInMainAxis");
...
bool ReactNativeFeatureFlagsAccessor::fuseboxAssertSingleHostState() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(61, "fuseboxAssertSingleHostState");
...
bool ReactNativeFeatureFlagsAccessor::fuseboxEnabledRelease() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(62, "fuseboxEnabledRelease");
...
bool ReactNativeFeatureFlagsAccessor::fuseboxFrameRecordingEnabled() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(63, "fuseboxFrameRecordingEnabled");
...
bool ReactNativeFeatureFlagsAccessor::fuseboxNetworkInspectionEnabled() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(64, "fuseboxNetworkInspectionEnabled");
...
bool ReactNativeFeatureFlagsAccessor::hideOffscreenVirtualViewsOnIOS() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(66, "hideOffscreenVirtualViewsOnIOS");
...
bool ReactNativeFeatureFlagsAccessor::overrideBySynchronousMountPropsAtMountingAndroid() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(67, "overrideBySynchronousMountPropsAtMountingAndroid");
...
bool ReactNativeFeatureFlagsAccessor::perfIssuesEnabled() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(68, "perfIssuesEnabled");
...
bool ReactNativeFeatureFlagsAccessor::perfMonitorV2Enabled() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(69, "perfMonitorV2Enabled");
...
double ReactNativeFeatureFlagsAccessor::preparedTextCacheSize() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(70, "preparedTextCacheSize");
...
bool ReactNativeFeatureFlagsAccessor::preventShadowTreeCommitExhaustion() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(71, "preventShadowTreeCommitExhaustion");
...
bool ReactNativeFeatureFlagsAccessor::redBoxV2Android() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(72, "redBoxV2Android");
...
bool ReactNativeFeatureFlagsAccessor::redBoxV2IOS() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(73, "redBoxV2IOS");
...
bool ReactNativeFeatureFlagsAccessor::shouldPressibilityUseW3CPointerEventsForHover() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(74, "shouldPressibilityUseW3CPointerEventsForHover");
...
bool ReactNativeFeatureFlagsAccessor::runtimeCrashUiThreadUtils() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(75, "runtimeCrashUiThreadUtils");
...
bool ReactNativeFeatureFlagsAccessor::useLISAlgorithmInDifferentiator() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(84, "useLISAlgorithmInDifferentiator");
...
bool ReactNativeFeatureFlagsAccessor::useOptimizedViewRegistryOnAndroid() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(87, "useOptimizedViewRegistryOnAndroid");
...
bool ReactNativeFeatureFlagsAccessor::usePullModelOnAndroid() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(88, "usePullModelOnAndroid");
...
bool ReactNativeFeatureFlagsAccessor::useSharedAnimatedBackend() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(89, "useSharedAnimatedBackend");
...
bool ReactNativeFeatureFlagsAccessor::useSilenceErrorSMMViewNotFound() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(90, "useSilenceErrorSMMViewNotFound");
...
bool ReactNativeFeatureFlagsAccessor::useTraitHiddenOnAndroid() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(91, "useTraitHiddenOnAndroid");
...
bool ReactNativeFeatureFlagsAccessor::useTraitHiddenOnIOS() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(92, "useTraitHiddenOnIOS");
...
bool ReactNativeFeatureFlagsAccessor::useTurboModuleInterop() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(93, "useTurboModuleInterop");
...
bool ReactNativeFeatureFlagsAccessor::useTurboModules() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(94, "useTurboModules");
...
bool ReactNativeFeatureFlagsAccessor::useUnorderedMapInDifferentiator() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(95, "useUnorderedMapInDifferentiator");
...
double ReactNativeFeatureFlagsAccessor::viewCullingOutsetRatio() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(96, "viewCullingOutsetRatio");
...
bool ReactNativeFeatureFlagsAccessor::viewTransitionEnabled() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(97, "viewTransitionEnabled");
...
double ReactNativeFeatureFlagsAccessor::virtualViewPrerenderRatio() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(98, "virtualViewPrerenderRatio");
